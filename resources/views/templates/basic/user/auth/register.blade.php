    ...
    <div class="left float-end">
        ...
        <div class="account-middle">
            <div class="account-form-area">
                ...
                <p>@lang('Please input your information to register')
                </p>
                    ...
                    <div class="row ml-b-20">
                        ...
                        <div class="form-group d-flex">
                            ...
                            <label for="agree">@lang('I agree with') @foreach($policyPages as $policy) <a
                                    href="{{ route('policy.details',[slug($policy->data_values->title),$policy->id]) }}">{{
                                    __($policy->data_values->title) }}</a>@if(!$loop->last), @endif @endforeach</label>
                        </div>
                        @endif
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="account-item mt-10">
                                <label>@lang('Already Have An Account?') <a href="{{ route('user.login') }}"
                                        class="text--base">@lang('Login
                                        Now')</a></label>
                            </div>
                        </div>
                    </div>
